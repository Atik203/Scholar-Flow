...
export interface CardWithVariantsProps
  extends React.ComponentProps<"div">,
    CardVariants {}

export const CardWithVariants = React.forwardRef<
  HTMLDivElement,
  CardWithVariantsProps
>(({ className, variant, padding, hover, size, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(cardVariants({ variant, padding, hover, size }), className)}
    {...props}
  />
));
