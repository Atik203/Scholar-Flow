...
export const Hero: React.FC = () => {
  ...
  const stats = [
    { number: 50, suffix: "K+", label: "Research Papers", icon: BookOpen, color: "text-blue-500" },
    { number: 12, suffix: "K+", label: "Active Researchers", icon: Users, color: "text-green-500" },
    { number: 3.5, suffix: "K+", label: "Collections Created", icon: FileText, color: "text-amber-500" },
    { number: 99.9, suffix: "%", label: "Uptime SLA", icon: Zap, color: "text-purple-500" },
  ];
  ...
  return (
    <section className="relative pt-28 pb-32 overflow-hidden" aria-labelledby="hero-heading">
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden">
        ...
        <FloatingParticle delay={1.5} duration={5.5} x="20%" y="70%" size={10} />
      ...
      <div className="mx-auto max-w-[1440px] px-4 sm:px-6 lg:px-8">
          ...
          <Link href="/features">
            ...
            >
              ...
              <span className="text-sm font-medium">
                <span className="text-primary">New:</span> AI-powered paper summaries now available
              </span>
        ...
        <div className="text-center mb-20">
          ...
          >
            ScholarFlow centralizes your papers, semantic search, AI summaries, annotations, and collection sharing so your literature review accelerates —{" "}
          ...
          >
            <motion.span className="flex items-center gap-2" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.8 }}>
        ...
        >
          {features.map((feature) => (
            ...
            >
              ...
              <motion.div className="absolute bottom-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity" initial={{ x: -10 }} whileHover={{ x: 0 }}>
        ...
        >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              ...
              >
                <div className={`inline-flex items-center justify-center w-12 h-12 rounded-xl bg-gradient-to-br from-muted to-muted/50 mb-3 ${stat.color} group-hover:scale-110 transition-transform`}>
                  <stat.icon className="h-6 w-6" />
                </div>
                <div className={`text-3xl md:text-4xl font-bold mb-1 ${stat.color}`}>
                  <AnimatedCounter target={stat.number} suffix={stat.suffix} decimals={stat.label === "Uptime SLA" || stat.label === "Collections Created" ? 1 : 0} />
                </div>
          ...
          <div className="mt-10 pt-8 border-t border-border/30">
            <div className="flex flex-wrap items-center justify-center gap-8">
              {[
                { icon: CheckCircle2, text: "99.9% Uptime SLA", color: "text-green-500" },
                { icon: CheckCircle2, text: "SOC 2 Certified", color: "text-blue-500" },
                { icon: CheckCircle2, text: "24/7 Support", color: "text-amber-500" },
                { icon: CheckCircle2, text: "GDPR Compliant", color: "text-purple-500" },
              ].map((item, i) => (
                <motion.div
                  key={item.text}
          ...
          <div className="mt-8 pt-6 border-t border-border/30">
            ...
            <div className="relative overflow-hidden">
              ...
              <div className="flex animate-marquee">
                {[...trustedInstitutions, ...trustedInstitutions].map((institution, i) => (
                  <div key={`${institution.name}-${i}`} className="flex-shrink-0 mx-8 group">
