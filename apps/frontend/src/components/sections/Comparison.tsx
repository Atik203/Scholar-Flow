...
const comparisonData = {
  ...
  competitors: [
    ...
    },
    {
      ...
      highlight: false,
      features: [
        "partial", "partial", true, "partial", true,
        true, "partial", "partial", false, true,
    ...
    },
    {
      ...
      features: [
        ...
        false, "partial", true, true, true,
        true, false, "native", true, false,
    ...
    },
    {
      ...
      features: [
        false, false, false, false, false,
        "partial", "partial", true, true, "partial",
        true, false, "native", true, false,
        "partial", false, false, false, "partial",
      ],
    },
    {
      name: "Paperpile",
...
const FeatureStatus = ({ status }: { status: boolean | string }) => {
  ...
  if (status === "partial") {
    return (
      <div className="w-6 h-6 rounded-full bg-amber-500/20 flex items-center justify-center mx-auto">
