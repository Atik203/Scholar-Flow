...
import { useGetMyCollectionsQuery, useGetCollectionStatsQuery } from "@/redux/api/collectionApi";
import {
  BookOpen,
  Plus,
  Search,
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <Card className="hover:shadow-md transition-shadow group">
            ...
            <CardContent className="pt-0">
              ...
              <Button asChild variant="outline" className="w-full">
                <Link href="/collections/public">Browse Collections</Link>
              </Button>
            </CardContent>
          </Card>
          ...
          <Card className="hover:shadow-md transition-shadow group">
            ...
            <CardContent className="pt-0">
              <p className="text-sm text-muted-foreground mb-3">
                View collections shared with you by collaborators
              </p>
              <Button asChild variant="outline" className="w-full">
                <Link href="/collections/shared">View Shared</Link>
              </Button>
            </CardContent>
          </Card>
        </div>
