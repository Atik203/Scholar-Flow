          ...
          <div className="mx-auto max-w-[1440px] px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                Have questions about ScholarFlow? Need help getting started? Our team is here to assist you.
              </p>
            </motion.div>
          </div>
        </section>
        ...
        <section className="py-16 md:py-24 bg-muted/30">
          <div className="mx-auto max-w-[1440px] px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                { icon: Mail, title: "Email Us", description: "support@scholarflow.io", action: "Send Email", color: "primary" },
                { icon: MessageSquare, title: "Live Chat", description: "Available 24/7", action: "Start Chat", color: "chart-1" },
                { icon: Phone, title: "Call Us", description: "+1 (555) 123-4567", action: "Call Now", color: "chart-2" },
                { icon: HelpCircle, title: "Help Center", description: "Browse FAQs", action: "View FAQs", color: "chart-3" },
              ].map(({ icon: Icon, title, description, action, color }, index) => (
                <motion.div
                  key={title}
                  initial={{ opacity: 0, y: 20 }}
                ...
                >
                  <Card className="h-full text-center hover:shadow-lg transition-all duration-300 hover:-translate-y-1 group cursor-pointer">
                    <CardContent className="p-6">
                      <div className={`w-16 h-16 rounded-full bg-${color}/10 flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-200`}>
              ...
              >
                <div>
                  ...
                  <div className="space-y-6">
                    {[
                      { city: "San Francisco", address: "123 Research Ave, SF, CA 94102", hours: "Mon-Fri: 9am-6pm PST" },
                      { city: "New York", address: "456 Innovation Blvd, NY, NY 10001", hours: "Mon-Fri: 9am-6pm EST" },
                      { city: "London", address: "789 Scholar Lane, London, UK EC1A 1BB", hours: "Mon-Fri: 9am-6pm GMT" },
                    ].map(({ city, address, hours }) => (
                      <Card key={city} className="hover:shadow-md transition-shadow duration-200">
                ...
                <Card className="border-2 bg-muted/50">
                  <CardContent className="p-6 text-center">
                    ...
                    <h3 className="font-semibold text-xl mb-2">Global Support</h3>
                    <p className="text-muted-foreground mb-4">
                      Our team is distributed globally to provide 24/7 support in multiple languages.
                    </p>
                    <Link href="/faq">
