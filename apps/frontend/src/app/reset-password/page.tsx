                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-xs text-green-700 dark:text-green-300 mt-1">
                      Your account is now protected with a new password. The old reset link has been invalidated.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="relative flex flex-col justify-center p-12 text-center">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground mb-8 max-w-md mx-auto">
                Your account is now secure with a new password. Sign in to continue your research journey.
              </p>
      ...
      <div className="hidden lg:flex lg:flex-1 relative overflow-hidden">
        ...
        <div className="relative flex flex-col justify-center p-12 text-center">
          ...
          >
            ...
            <h2 className="text-3xl font-bold mb-4">Strong Password Guidelines</h2>
            <p className="text-lg text-muted-foreground mb-8 max-w-md mx-auto">
              Create a strong password that&apos;s both secure and memorable for your research account.
            </p>
            <div className="space-y-4">
              <div className="flex items-center gap-3 text-sm">
