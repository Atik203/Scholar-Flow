            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li>
                    <strong>BibTeX:</strong> LaTeX documents, academic papers
                  </li>
                  <li>
                    <strong>EndNote:</strong> Research management, large
                    bibliographies
                  </li>
                  <li>
                    <strong>APA:</strong> Psychology, social sciences, education
                  </li>
                  <li>
                    <strong>MLA:</strong> Literature, humanities, language
                    studies
                  </li>
                  <li>
                    <strong>IEEE:</strong> Engineering, computer science,
                    technology
                  </li>
                  <li>
                    <strong>Chicago:</strong> History, general academic writing
                  </li>
                  <li>
                    <strong>Harvard:</strong> General academic writing, business
                  </li>
                </ul>
              </div>
              <div>
