              ...
              {[
                {
                  ...
                  description: "Account setup, first login, uploading papers, and basic navigation through the platform.",
                  color: "primary",
                },
                {
                  icon: Search,
                  title: "Search & Discovery",
                  description: "Advanced search techniques, filters, citation networks, and finding related research.",
                  color: "chart-1",
                },
                {
                  icon: BookOpen,
                  title: "Organization",
                  description: "Collections, tags, folders, sharing, and collaborative research management.",
                  color: "chart-2",
                },
                {
                  icon: Lightbulb,
                  title: "AI Features",
                  description: "Summaries, insights, recommendations, and intelligent paper analysis tools.",
                  color: "chart-3",
                },
                {
                  icon: Code,
                  title: "API Integration",
                  description: "REST APIs, webhooks, authentication, and building custom integrations.",
                  color: "chart-4",
                },
                {
                  icon: Zap,
                  title: "Advanced Workflows",
                  description: "Automation, batch operations, team management, and enterprise features.",
                  color: "chart-5",
                },
