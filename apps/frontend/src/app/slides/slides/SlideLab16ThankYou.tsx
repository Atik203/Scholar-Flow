...
export default function SlideLab16ThankYou() {
  return (
    <div className="w-full h-full bg-white p-12 flex flex-col items-center justify-center gap-6 relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center text-center gap-5">
        ...
        <p className="text-2xl text-black font-semibold">Any Questions?</p>
