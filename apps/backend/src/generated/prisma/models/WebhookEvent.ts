...
export type WebhookEventWhereInput = {
  ...
  isDeleted?: Prisma.BoolFilter<"WebhookEvent"> | boolean
}
...
export type WebhookEventScalarWhereWithAggregatesInput = {
  ...
  isDeleted?: Prisma.BoolWithAggregatesFilter<"WebhookEvent"> | boolean
}
...
export type WebhookEventOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "provider" | "eventId" | "type" | "payload" | "receivedAt" | "processedAt" | "status" | "error" | "attempts" | "createdAt" | "updatedAt" | "isDeleted", ExtArgs["result"]["webhookEvent"]>
...
export interface WebhookEventFieldRefs {
  ...
  readonly isDeleted: Prisma.FieldRef<"WebhookEvent", 'Boolean'>
}
