...
export type PageContentWhereInput = {
  ...
  isDeleted?: Prisma.BoolFilter<"PageContent"> | boolean
}
...
export type PageContentScalarWhereWithAggregatesInput = {
  ...
  isDeleted?: Prisma.BoolWithAggregatesFilter<"PageContent"> | boolean
}
...
export type PageContentOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "slug" | "title" | "content" | "metadata" | "isPublished" | "createdAt" | "updatedAt" | "isDeleted", ExtArgs["result"]["pageContent"]>
...
export interface PageContentFieldRefs {
  ...
  readonly isDeleted: Prisma.FieldRef<"PageContent", 'Boolean'>
}
