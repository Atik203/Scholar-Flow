...
class AuthController {
   ...
   */
  register: AsyncRequestHandler = catchAsync(
    async (req: Request, res: Response) => {
      const {
        firstName,
        lastName,
   ...
   */
  oauthSignin: AsyncRequestHandler = catchAsync(
    async (req: Request, res: Response) => {
   ...
   */
  validateSession: AsyncRequestHandler = catchAsync(
    async (req: Request, res: Response) => {
   ...
   */
  getSession: AsyncRequestHandler = catchAsync(
    async (req: Request, res: Response) => {
   ...
   */
  createSession: AsyncRequestHandler = catchAsync(
    async (req: Request, res: Response) => {
   ...
   */
  deleteSession: AsyncRequestHandler = catchAsync(
    async (req: Request, res: Response) => {
      const { sessionToken } = req.body as ISessionValidationRequest;
   ...
   */
  forgotPassword: AsyncRequestHandler = catchAsync(
    async (req: Request, res: Response) => {
   ...
   */
  resetPassword: AsyncRequestHandler = catchAsync(
    async (req: Request, res: Response) => {
   ...
   */
  verifyEmail: AsyncRequestHandler = catchAsync(
    async (req: Request, res: Response) => {
   ...
   */
  sendEmailVerification: AsyncRequestHandler = catchAsync(
    async (req: Request, res: Response) => {
