          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            >
              ...
              <div className="bg-white/5 backdrop-blur-xl rounded-xl border border-white/10 p-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-gray-400 text-sm">Starred</span>
                ...
                <div className="space-y-2">
                  {trendingSearches.map((trend, index) => (
                    ...
                    >
                      ...
                      <span className="flex-1 text-left text-gray-300 text-sm truncate group-hover:text-white transition-colors">
                        {trend.query}
                      </span>
            ...
            >
                              ...
                              <div className="flex-1 min-w-0">
                                <div className="flex items-start justify-between gap-4">
                                  ...
                                  <div className="flex items-center gap-2">
                                    ...
                                    <button
                                      ...
                                      className="p-1.5 rounded-lg text-gray-500 hover:text-white opacity-0 group-hover:opacity-100 transition-all"
                                    >
                                ...
                                {item.filters && (
                                  <div className="flex flex-wrap gap-2 mt-2">
                                    {item.filters.dateRange && (
                                      <span className="inline-flex items-center gap-1 px-2 py-0.5 bg-white/5 rounded text-xs text-gray-400">
                                ...
                                {item.lastResultClicked && (
                                  <button
                                    ...
                                    className="mt-2 inline-flex items-center gap-2 px-3 py-1.5 bg-white/5 rounded-lg text-sm text-gray-400 hover:text-white hover:bg-white/10 transition-colors"
                                  >
              ...
              <div className="mt-6 flex justify-center">
                <button className="inline-flex items-center gap-2 px-4 py-2 text-gray-400 hover:text-white transition-colors">
