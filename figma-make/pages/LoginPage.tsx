...
export function LoginPage({ onNavigate }: LoginPageProps) {
  ...
  const features = [
    ...
    "Semantic search across all your papers",
  ...
  return (
    <div className="min-h-screen bg-background flex">
        ...
        <div className="w-full max-w-md">
          ...
          >
            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <Button
                type="submit"
                className="w-full h-11 bg-gradient-to-r from-primary to-[var(--chart-1)] text-white shadow-lg hover:shadow-xl transition-all duration-300"
                size="lg"
              >
                Sign In
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-primary to-[var(--chart-1)] p-12 items-center justify-center relative overflow-hidden">
        {/* Background patterns */}
        ...
        <div className="relative max-w-md text-center text-white">
          ...
          <p className="text-white/80 mb-8">
            Join thousands of researchers who use ScholarFlow to manage their
            papers, collaborate with teams, and discover insights faster.
          </p>
