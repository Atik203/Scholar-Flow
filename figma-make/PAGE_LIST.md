...
| **AI & Insights**      |                            |                              |                                 |
| 66                     | AIInsightsPage             | `/ai-insights`               | Sidebar: AI Insights            |
| 67                     | DiscussionsPage            | `/discussions`               | Paper details page              |
| **Admin Only**         |                            |                              |                                 |
| 68                     | AdminOverviewPage          | `/admin-overview`            | Sidebar: Admin                  |
| 69                     | UserManagementPage         | `/admin/users`               | Sidebar: Admin > Users          |
| 70                     | SubscriptionsPage          | `/admin/subscriptions`       | Sidebar: Admin > Subs           |
| 71                     | SystemSettingsPage         | `/admin/settings`            | Sidebar: Admin > Settings       |
| 72                     | AdminReportsPage           | `/admin/reports`             | Sidebar: Admin > Reports        |
| 73                     | AdminAuditLogPage          | `/admin/audit`               | Sidebar: Admin > Audit          |
| 74                     | AdminPlansPage             | `/admin/plans`               | Sidebar: Admin > Plans          |
| 75                     | AdminPaymentsPage          | `/admin/payments`            | Sidebar: Admin > Payments       |
| 76                     | AdminWebhooksPage          | `/admin/webhooks`            | Sidebar: Admin > Webhooks       |
| 77                     | AdminAPIKeysPage           | `/admin/api-keys`            | Sidebar: Admin > API Keys       |
| 78                     | AdminContentModerationPage | `/admin/moderation`          | Sidebar: Admin > Moderation     |
| **Marketing/Public**   |                            |                              |                                 |
| 79                     | FeaturesPage               | `/features`                  | Public navbar                   |
| 80                     | HowItWorksPage             | `/how-it-works`              | Public navbar                   |
| 81                     | PricingPage                | `/pricing`                   | Public navbar                   |
| 82                     | FAQPage                    | `/faq`                       | Public navbar                   |
| **Products**           |                            |                              |                                 |
| 83                     | PapersProductPage          | `/products/papers`           | Footer / Marketing              |
| 84                     | CollectionsProductPage     | `/products/collections`      | Footer / Marketing              |
| 85                     | CollaborateProductPage     | `/products/collaborate`      | Footer / Marketing              |
| 86                     | AIInsightsProductPage      | `/products/ai-insights`      | Footer / Marketing              |
| **Resources**          |                            |                              |                                 |
| 87                     | DocsPage                   | `/resources/docs`            | Footer / Marketing              |
| 88                     | TutorialsPage              | `/resources/tutorials`       | Footer / Marketing              |
| 89                     | APIPage                    | `/resources/api`             | Footer / Marketing              |
| 90                     | CommunityPage              | `/resources/community`       | Footer / Marketing              |
| **Company**            |                            |                              |                                 |
| 91                     | AboutPage                  | `/company/about`             | Footer / Marketing              |
| 92                     | CareersPage                | `/company/careers`           | Footer / Marketing              |
| 93                     | ContactPage                | `/company/contact`           | Footer / Marketing              |
| 94                     | PressPage                  | `/company/press`             | Footer / Marketing              |
| **Enterprise**         |                            |                              |                                 |
| 95                     | EnterprisePage             | `/enterprise`                | Public navbar                   |
| 96                     | TeamsPage                  | `/enterprise/teams`          | Enterprise submenu              |
| 97                     | IntegrationsPage           | `/enterprise/integrations`   | Enterprise submenu              |
| 98                     | SupportPage                | `/enterprise/support`        | Enterprise submenu              |
| **Utility**            |                            |                              |                                 |
| 99                     | NotFoundPage               | `/not-found`                 | 404 redirect                    |
| 100                    | ErrorPage                  | `/error`                     | Error boundary                  |
| 101                    | LoadingPage                | `/loading`                   | Loading state                   |
