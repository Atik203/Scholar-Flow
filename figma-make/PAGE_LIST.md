...
| 57                     | DiscoverPage               | `/discover`                | Sidebar: Discover               |
| **Help**               |                            |                            |                                 |
| 58                     | HelpCenterPage             | `/help`                    | Sidebar: Help > Center          |
| 59                     | KeyboardShortcutsPage      | `/help/shortcuts`          | Sidebar: Help > Shortcuts       |
| **Settings**           |                            |                            |                                 |
| 60                     | ProfilePage                | `/profile`                 | User menu > Profile             |
| 61                     | SettingsPage               | `/settings`                | User menu > Settings            |
| 62                     | BillingPage                | `/billing`                 | Sidebar: Billing                |
| 63                     | ExportDataPage             | `/settings/export`         | Settings page                   |
| **AI & Insights**      |                            |                            |                                 |
| 64                     | AIInsightsPage             | `/ai-insights`             | Sidebar: AI Insights            |
| 65                     | DiscussionsPage            | `/discussions`             | Paper details page              |
| **Admin Only**         |                            |                            |                                 |
| 66                     | AdminOverviewPage          | `/admin-overview`          | Sidebar: Admin                  |
| 67                     | UserManagementPage         | `/admin/users`             | Sidebar: Admin > Users          |
| 68                     | SubscriptionsPage          | `/admin/subscriptions`     | Sidebar: Admin > Subs           |
| 69                     | SystemSettingsPage         | `/admin/settings`          | Sidebar: Admin > Settings       |
| 70                     | AdminReportsPage           | `/admin/reports`           | Sidebar: Admin > Reports        |
| 71                     | AdminAuditLogPage          | `/admin/audit`             | Sidebar: Admin > Audit          |
| 72                     | AdminPlansPage             | `/admin/plans`             | Sidebar: Admin > Plans          |
| 73                     | AdminPaymentsPage          | `/admin/payments`          | Sidebar: Admin > Payments       |
| 74                     | AdminWebhooksPage          | `/admin/webhooks`          | Sidebar: Admin > Webhooks       |
| 75                     | AdminAPIKeysPage           | `/admin/api-keys`          | Sidebar: Admin > API Keys       |
| 76                     | AdminContentModerationPage | `/admin/moderation`        | Sidebar: Admin > Moderation     |
| **Marketing/Public**   |                            |                            |                                 |
| 77                     | FeaturesPage               | `/features`                | Public navbar                   |
| 78                     | HowItWorksPage             | `/how-it-works`            | Public navbar                   |
| 79                     | PricingPage                | `/pricing`                 | Public navbar                   |
| 80                     | FAQPage                    | `/faq`                     | Public navbar                   |
| **Products**           |                            |                            |                                 |
| 81                     | PapersProductPage          | `/products/papers`         | Footer / Marketing              |
| 82                     | CollectionsProductPage     | `/products/collections`    | Footer / Marketing              |
| 83                     | CollaborateProductPage     | `/products/collaborate`    | Footer / Marketing              |
| 84                     | AIInsightsProductPage      | `/products/ai-insights`    | Footer / Marketing              |
| **Resources**          |                            |                            |                                 |
| 85                     | DocsPage                   | `/resources/docs`          | Footer / Marketing              |
| 86                     | TutorialsPage              | `/resources/tutorials`     | Footer / Marketing              |
| 87                     | APIPage                    | `/resources/api`           | Footer / Marketing              |
| 88                     | CommunityPage              | `/resources/community`     | Footer / Marketing              |
| **Company**            |                            |                            |                                 |
| 89                     | AboutPage                  | `/company/about`           | Footer / Marketing              |
| 90                     | CareersPage                | `/company/careers`         | Footer / Marketing              |
| 91                     | ContactPage                | `/company/contact`         | Footer / Marketing              |
| 92                     | PressPage                  | `/company/press`           | Footer / Marketing              |
| **Enterprise**         |                            |                            |                                 |
| 93                     | EnterprisePage             | `/enterprise`              | Public navbar                   |
| 94                     | TeamsPage                  | `/enterprise/teams`        | Enterprise submenu              |
| 95                     | IntegrationsPage           | `/enterprise/integrations` | Enterprise submenu              |
| 96                     | SupportPage                | `/enterprise/support`      | Enterprise submenu              |
| **Utility**            |                            |                            |                                 |
| 97                     | NotFoundPage               | `/not-found`               | 404 redirect                    |
| 98                     | ErrorPage                  | `/error`                   | Error boundary                  |
| 99                     | LoadingPage                | `/loading`                 | Loading state                   |
...
## All 99 Pages Complete & Navigable
