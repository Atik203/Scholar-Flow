...
Version: 1.1.0 (20 releases, 803 commits)
...
Root: Turborepo v2.5.8 + Yarn Berry v4.9.2
  apps/frontend/    → Next.js 15 app (package: @scholar-flow/frontend)
...
Auth: NextAuth.js (Google OAuth, GitHub OAuth, email/password)
...
Auth task:
  → apps/frontend/lib/ (NextAuth config)
...
- Never suggest NextAuth alternatives
- Never suggest better-auth
