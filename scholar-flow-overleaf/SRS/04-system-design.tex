...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{images/diagrams/context_diagram.png}
...
The core feature use cases are captured in four focused diagrams (Figures~\ref{fig:srs-use-case-diagram-1}--\ref{fig:srs-use-case-diagram-4}) that highlight distinct interaction scopes.
...
\begin{figure}[H]
    ...
    \label{fig:srs-use-case-diagram-1}
\end{figure}
...
\begin{figure}[H]
    ...
    \label{fig:srs-use-case-diagram-2}
\end{figure}
...
\begin{figure}[H]
    ...
    \label{fig:srs-use-case-diagram-3}
\end{figure}
...
\begin{figure}[H]
    ...
    \label{fig:srs-use-case-diagram-4}
\end{figure}
