...
The design artifacts are documented using six diagrams: \textbf{context diagram}, \textbf{use case diagram (with descriptive forms)}, \textbf{data flow diagram (DFD)}, \textbf{activity diagram}, \textbf{ERD}, and \textbf{relational schema diagram}.
