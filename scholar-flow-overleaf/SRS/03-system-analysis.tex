...
To maintain academic clarity, we consolidate the cross-platform feature benchmark into a single visual matrix (Figure~\ref{fig:benchmark-matrix}). The matrix adheres to a three-level evaluation rubric—full support, partial support, and not available—applied uniformly across six peer systems. This presentation emphasizes relative capability breadth while preserving replicability of the underlying coding scheme.
