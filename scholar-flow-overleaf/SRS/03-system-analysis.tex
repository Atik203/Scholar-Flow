...
\begin{table}[H]
    ...
    \begin{tabular}{|p{3cm}|p{4cm}|p{5cm}|}
        ...
        extbf{AI-First Architecture}: Semantic search (pgvector), AI summaries (65.6\% selection), multi-paper chat, deep research mode with citation context              \\
        \hline
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|p{6.5cm}|p{6.5cm}|}
        ...
        \hline
        First-mover advantage in Bangladesh; UIU concentration (\textasciitilde{}60\%) for rapid word-of-mouth                                                         & Go-to-market playbook for campuses still forming; limited field presence today                      \\
        \hline
    \end{tabularx}
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|p{6.5cm}|p{6.5cm}|}
        ...
        \hline
        Underserved campus market in Bangladesh; ambassador-led viral loops                    & Adoption uncertainty: 21.9\% “not sure” about trying the free tier; 18.8\% show low interest; incumbents can copy AI features \\
        \hline
...
\begin{enumerate}
    ...
    \item \textbf{First-Mover Advantage in Local Market}
          \begin{itemize}
              ...
              \item UIU campus concentration (\textasciitilde{}60\%) enables rapid word-of-mouth
...
\begin{enumerate}
    ...
    \item \textbf{Mobile-First \& Gen-Z Alignment}
          \begin{itemize}
              \item 68.8\% users ages 22--25 (digital natives)
