...
\begin{itemize}
    \item \textbf{Primary Research}: Survey of 29 academic researchers across 10 universities
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|l|p{7cm}|}
        ...
        Need lightweight tools with minimal learning curve; prefer mobile access; value AI summaries for time-saving (82.7\% survey demand)    \\
        \hline
...
\begin{itemize}
    \item \textbf{47.4\%} of survey respondents from United International University (UIU)
    ...
    \item Campus network effects enable organic growth through word-of-mouth and shared workspace invitations
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Forrester: Future of Academic Software 2023} --- Highlighted Gen-Z expectations for modern UX, OAuth, and AI-first features; forecasted decline of legacy reference managers
...
\begin{itemize}
    ...
    \item \textbf{Twitter Academic Community (\#AcademicTwitter)} --- Viral threads on research workflow frustrations; strong interest in AI-powered tools; demand for Notion-like UX for papers
...
\begin{itemize}
    ...
    \item \textbf{Salman Nayeem (Backend Developer)}: Expertise in API design, database optimization, and cloud infrastructure (AWS S3, Docker, EC2)

    \item \textbf{Sagor Ahmed (Frontend Developer)}: Specialization in React, Redux, and modern UI/UX design; implemented responsive dashboards and rich text editors

    \item \textbf{Sarowar Sourov (QA Engineer)}: Focus on automated testing, CI/CD pipelines, and performance monitoring
\end{itemize}
...
\begin{enumerate}
    \item \textbf{Zotero} (Free, Open-Source)
          \begin{itemize}
              ...
              \item \textit{Weaknesses}: Outdated UI (desktop app feels like 2010), no AI features, limited collaboration (basic group libraries)
...
\begin{itemize}
    ...
    \item \textbf{Weaknesses}: Outdated desktop UI (feels like 2010), no AI features, limited collaboration (basic group libraries), slow sync
...
\begin{itemize}
    ...
    \item \textbf{Search Inefficiency}: \textbf{37.9\%} struggle to find papers when needed
    \item \textbf{Organization Chaos}: \textbf{44.8\%} can't keep notes/highlights organized
    \item \textbf{Collaboration Friction}: \textbf{24.1\%} cite team collaboration as major pain point
...
\begin{itemize}
    ...
    \item \textbf{Time Savings}: Cut research admin overhead by \textbf{40--50\%} (validated by AI summary demand: 82.7\%)
    ...
    \item \textbf{User Satisfaction}: Target \textbf{4.5/5 satisfaction} (vs. current 3.31/5 with existing tools)
...
\begin{enumerate}
    \item \textbf{AI-First Tools}: Gen-Z researchers expect AI as default (not optional); ScholarFlow makes AI central to every workflow (search, summaries, chat)

    \item \textbf{Modern UX}: Legacy tools (Zotero/Mendeley) feel outdated; ScholarFlow provides Notion-like UX with dark mode, glassmorphism, responsive design
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|p{10cm}|}
        ...
        Target early adopters (UIU 47.4\% concentration); offer import from Zotero/Mendeley; emphasize AI features (semantic search, summaries) as key differentiators \\
        \hline
